...
const reasons = [
  {
    ...
    description: "Automations designed to save hours and cut costs from day one.",
  },
  {
    icon: Zap,
    title: "Fast & Affordable",
    description: "Go live in days, with pricing that grows with you.",
  },
  {
    icon: ShieldCheck,
    title: "No Tech Headaches",
    description: "We handle integrations, edge cases, and maintenance.",
  },
  {
    icon: User,
    title: "Human + AI",
    description: "AI that works, supported by people who care.",
  },
];
...
export function WhyFoxxageSection() {
  return (
