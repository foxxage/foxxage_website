...
const Youtube = (props: SVGProps<SVGSVGElement>) => <svg {...props} viewBox="0 0 24 24"><path fill="currentColor" d="M10 15l5-3l-5-3v6m11.56-7.83c.13.47.22 1.1.28 1.9c.07.8.1 1.49.1 2.09L22 12c0 2.19-.16 3.8-.44 5.17c-.28 1.37-.9 2.3-1.82 2.83c-1.12.62-3.15.94-5.74.94s-4.62-.32-5.74-.94c-.92-.53-1.54-1.46-1.82-2.83c-.28-1.37-.44-2.98-.44-5.17s.16-3.8.44-5.17c.28-1.37.9-2.3 1.82-2.83c1.12-.62 3.15-.94 5.74-.94c2.59 0 4.62.32 5.74.94c.92.53 1.54 1.46 1.82 2.83Z" /></svg>;
